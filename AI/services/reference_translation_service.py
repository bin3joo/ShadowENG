...
def _build_prompt(
    ...
    return (
        ...
        "2. Merge adjacent preprocessed parts ONLY IF they form a logically and grammatically continuous thought AND the resulting combined duration does not exceed 10 seconds. Ignore external speaker_hints if they conflict with logical continuity.\n"
        ...
        "5. Extract 2 to 4 highly reusable English learning expressions based on the rules below.\n"
        "6. For each merged part, extract 2 to 4 highly useful expressions, idioms, slang items, collocations, or key vocabulary.\n"
        ...
        "- [CRITICAL MERGE RULE] The total combined duration of a merged part (calculated as the final 'end_sec' minus the initial 'start_sec', or the sum of 'duration_sec') MUST NOT exceed 10 seconds. If adding the next adjacent part would exceed 10 seconds, you MUST stop merging and start a new merged part.\n"
